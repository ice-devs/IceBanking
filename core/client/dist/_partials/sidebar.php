<aside class="main-sidebar sidebar-dark-primary elevation-4" style="width : 0px">  
  <!-- Brand Logo 
    and load this 
  ...
  ?>
    <div class="bars bars-small" style="display:none" id="mySidebar">
      
      <a href="javascript:void(0)" style="color:white;"class="closebtn" onclick="w3_close()">&times;</a>
      <!-- Sidebar -->
      <div class="sidebar">
